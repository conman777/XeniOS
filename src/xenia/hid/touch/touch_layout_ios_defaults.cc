...
IOSTouchLayoutModel CreateDefaultIOSFPSLayoutModel() {
  ...
  layout.controls.push_back(
      MakeDefaultIOSTouchControlDefinitionImpl(IOSTouchControlType::kMoveStick));
  layout.controls.push_back(
      MakeDefaultIOSTouchControlDefinitionImpl(IOSTouchControlType::kLookSwipeZone));
  layout.controls.push_back(
      MakeDefaultIOSTouchControlDefinitionImpl(IOSTouchControlType::kPauseButton));
