...
typedef void (^XeniaCompatReportSubmissionCompletion)(
    NSString* issue_url, NSDictionary* compat_info, NSDictionary* discussion_snapshot,
    NSString* error_title, NSString* error_message);
