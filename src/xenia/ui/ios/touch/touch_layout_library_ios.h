...
inline constexpr const char* kOfficialTouchLayoutExpandedLocalID =
    "fps_expanded";
inline constexpr const char* kOfficialTouchLayoutMirroredLocalID =
    "fps_mirrored";
inline constexpr const char* kTouchLayoutAssignmentSection =
    "TouchLayoutAssignment";
