...
constexpr ThemeShadowTokens kSharedShadows = {
    /* subtle   */ {/*radius*/ 8.0f, /*dark*/ 0.14f, /*light*/ 0.10f, 0.0f, 8.0f},
    /* medium   */ {/*radius*/ 14.0f, /*dark*/ 0.42f, /*light*/ 0.18f, 0.0f, 8.0f},
    /* elevated */ {/*radius*/ 18.0f, /*dark*/ 0.55f, /*light*/ 0.22f, 0.0f, 10.0f},
};
...
constexpr ThemeTokens kThemeLight = {
    ...
    kSharedTypographyScale,
    ThemeSectionIconTokens{
        // Darker variants for the same categorical palette on light backgrounds.
