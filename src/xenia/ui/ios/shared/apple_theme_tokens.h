...
// typedef on Apple platforms: regular=0.0, medium=0.23, semibold=0.3, bold=0.4).
// The Objective-C side maps each style to a UIFontTextStyle for Dynamic Type
// scaling.
...
// previously used by the settings hub (systemBlue/Indigo/Orange/Purple/Red/Gray).
// Variant-aware so each picks the correct shade for dark and light traits.
